...
export default class MsgDesign extends Component {
    render() {
        return (
            ...
            <div className="p-5 mb-4 bg-light  rounded-3">
                    ...
                    <p>This document contains instructions on how to integrate Taggstar with your own website analytics
                        provider in order to allow you to analyse Taggstar social proof data. Experience of JavaScript and
                        web development tools is required.
