...
import DataSurvey from "../pages/data-survey.component";
import MsgCopy from "../pages/msg-copy.component";
import MsgDesign from "../pages/msg-design.component";
  ...
  render() {
    return (
      <div className="d-flex flex-wrap justify-content-around">
        ...
        <div class="album py-5">
          <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col">
                <div class="card  bg-g shadow-lg  rounded">
                  <div class="card-body">
                    <h1 className="display-4 fw-bold text-white" id="data-survey">Data Survey</h1>
                    ...
                    <Link to={"/data-survey"}>
                      <button type="button" class="btn btn-lg btn-outline-light text-white">View</button>
                  </Link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="card  bg-g shadow-lg  rounded">
                  <div class="card-body">
                    <h1 className="display-4 fw-bold text-white" id="data-survey">Message Copy</h1>
                    <p className=" text-white">This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing, so be on the lookout for this exact same string of text.</p>
                    <div class="d-flex justify-content-between align-items-center">
                    <Link to={"/msg-copy"}>
                      <button type="button" class="btn btn-lg btn-outline-light text-white">View</button>
              ...
              <div class="col">
                <div class="card  bg-g shadow-lg  rounded">
                  <div class="card-body">
                    <h1 className="display-4 fw-bold text-white" id="data-survey">Message Desgin</h1>
                    <p className=" text-white">This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing, so be on the lookout for this exact same string of text.</p>
                    <div class="d-flex justify-content-between align-items-center">
                    <Link to={"/msg-design"}>
                      <button type="button" class="btn btn-lg btn-outline-light text-white">View</button>
        ...
        <div>
          <Switch>
              <Route path="/data-survey" component={DataSurvey} />
              <Route exact path="/msg-copy" component={MsgCopy} />
              <Route exact path="/msg-desgn" component={MsgDesign} />
            </Switch>
        </div>
      </div>
    );
